...
if __name__ == "__main__":
    ...
    embedding_manager_ckpt_path = './logs/2023-10-30T20-52-24_example_training-sd_xl_base_ti/checkpoints/embeddings_gs-2000.pt'
    state['model'].embedding_manager.load(embedding_manager_ckpt_path, is_norm=False)
    if state["msg"]:
        st.info(state["msg"])
    model = state["model"]
